...
public class FeedbackFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_feedback,
                container, false);
        final RadioGroup radioGroup = rootView.findViewById(R.id.radio_group);
        // Retrieve the radio button choice (if a choice was made), and pre-select the radio button.
    ...
    public static FeedbackFragment newInstance(int choice) {
